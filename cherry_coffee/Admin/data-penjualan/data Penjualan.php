...
$query = "SELECT * FROM pemesanan WHERE status = 'selesai' ORDER BY id_pesanan DESC";
...
<head>
    ...
    <!----======== CSS ======== -->
    <link rel="stylesheet" href="../data-penjualan/style.css">
            ...
            <div class="activity">
                <div class="title1">
                    <div class="bg-image-list">
                        <img src="../gambar/list-putih.png" alt="">
                    </div>

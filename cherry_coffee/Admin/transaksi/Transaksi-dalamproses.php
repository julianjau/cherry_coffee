...
// Query untuk mendapatkan data pesanan dengan status 'dalam_proses'
$query = "SELECT * FROM pemesanan WHERE status = 'diterima' ORDER BY id_pesanan DESC";
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title1">
                    ...
                    <span class="text">Transaksi / dalam proses</span>
                </div>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <select name="status" onchange="updateStatus(<?php echo $row['id_pesanan']; ?>, this.value)">
                                    ...
                                    <option value="dalam_proses" <?php echo ($row['status'] == 'dalam_proses') ? 'selected' : ''; ?>>
                                        Dalam proses
                                    </option>

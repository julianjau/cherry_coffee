        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title1">
                    ...
                    <span class="text">Menu / <small> Minuman </small></span>
                </div>
            </div>

            <div>
                <a href="tambah-minuman.php" class="new-item">
                    ...
                    <tbody>
                        ...
                        foreach ($dataMenu as $menu) {
                            if ($menu['jenis_menu'] == 'MU') {
                                ...
                                echo "<td>";
                                echo "<div class='cs'>";
                                echo "<a href='edit-minuman.php?id={$menu['id_menu']}' class='edit-link'>";
                                echo "<button class='edit-btn'>Edit</button>";
                                echo "</a>";
                                echo "<div class='cc'></div>";

                                echo "<form action='hapus_minuman.php' method='post' onsubmit='return confirm(\"Apakah Anda yakin ingin menghapus menu ini?\")'>";
            ...
            <div class="pagination" id="pagination" style="margin-top:1px;">

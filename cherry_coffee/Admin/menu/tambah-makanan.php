        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title1">
                    ...
                    <span class="text">Menu / <small>Tambah Menu Makanan</small></span>
                </div>
            </div>
                ...
                <div class="tambah1">
                    <div class="tambah2">
                        ...
                        <div class="bottom-tambah">
                            <form action="proses_tambah_makanan.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="op-button">
                                    <a href="Menu-makanan.php" class="cancel-button">
